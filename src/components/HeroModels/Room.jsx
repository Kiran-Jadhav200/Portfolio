...
export function Room(props) {
  ...
  const codeScreenTexture = useTexture("/images/codescreen.png");
  const springTexture = useTexture("/images/spring.png");
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        material={new THREE.MeshBasicMaterial({ map: codeScreenTexture, toneMapped: false, opacity: 1, transparent: false })}
      />
      <mesh
